            ...
            <div class="app-navbar flex-shrink-0">
                ...
                <div class="app-navbar-item ms-1 ms-md-4">
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-title-gray-700 menu-icon-gray-500 menu-active-bg menu-state-color fw-semibold py-4 fs-base w-200px"
                        data-kt-menu="true" data-kt-element="website-menu">
                        <!--begin::Menu items-->
                        @foreach ($websites as $website)
                            <div class="menu-item px-3 my-0">
                                <a href="{{ url('admin/change-website/' . $website->id) }}"
                                    class="menu-link px-3 py-2 {{ $website->active == 1 ? 'active' : '' }}">
                                    <span class="menu-title">{{ $website->name }}</span>
                                </a>
                            </div>
                        @endforeach
                        <!--end::Menu items-->
