                    ...
                    <div class="card-body p-lg-17">
                        <div class="row mb-3">
                            <div class="col-md-10 pe-lg-10">
                                <form action="{{ route('store-category') }}" class="form mb-15" method="POST"
                                    enctype="multipart/form-data">
                                    @csrf
                                    <h1 class="fw-bold text-gray-900 mb-9">Create Category</h1>
                                    <div class="row mb-3">
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-md-6 fv-row">
                                            ...
                                            <textarea class="form-control form-control-solid" rows="3" name="description" placeholder=""></textarea>
                                        </div>
                                    </div>
