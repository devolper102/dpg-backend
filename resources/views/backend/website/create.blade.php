                    ...
                    <div class="card-body p-lg-17">
                        <div class="row mb-3">
                            <div class="col-md-10 pe-lg-10">
                                <form action="{{ route('store-website') }}" class="form mb-15" method="POST"
                                    enctype="multipart/form-data">
                                    @csrf
                                    <h1 class="fw-bold text-gray-900 mb-9">Create Website</h1>
                                    <div class="row mb-3">
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-md-6 fv-row">
                                            ...
                                            <input type="text" class="form-control form-control-solid" name="contact" />
                                        </div>
                                        <div class="col-md-6 fv-row">
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-md-6 fv-row">
                                            <label class="fs-5 fw-semibold mb-2 mt-2">Open Time</label>
                                            <input type="time" class="form-control form-control-solid"
                                                name="open_time" />
                                        </div>
                                        <div class="col-md-6 fv-row">
                                            <label class="fs-5 fw-semibold mb-2 mt-2">Close Time</label>
                                            <input type="time" class="form-control form-control-solid"
                                                name="close_time" />
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <div class="col-md-6 fv-row">
                                            ...
                                            <textarea class="form-control form-control-solid" rows="2" name="address"></textarea>
                                        </div>
                                        <div class="col-md-6 fv-row">
                                            <label class="fs-6 fw-semibold mb-2">Description</label>
                                            <textarea class="form-control form-control-solid" rows="2" name="description"></textarea>
                                        </div>
                                    </div>
